...
class MyApp(Cloudflare):
    ...
    def deploy_worker(self):
        ...
        if self.worker.upload(
            self.worker_name, "./examples/sample_data/advance_worker.js", metadata
        ):
    ...
    def check_worker(self):
        ...
        # Worker.download
        if self.worker.download(self.worker_name, directory="downloads"):
            print(
...
def main():
    ...
    # Cloudflare
    app = MyApp(worker_name="advance-test-worker")
